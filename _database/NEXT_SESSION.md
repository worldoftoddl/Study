...
### 16. 적용사례(IE) 분리: 1024호 추가 (2026-03-18)
- **MD 직접 분리** (테이블 깨짐 없음, 텍스트 위주):
  - 1024호 특수관계자공시 (108줄, 사례 6개 IE1~IE26 + 문단비교표)
- **원본 MD에서 적용사례 섹션 제거**: 151줄 삭제 (526 → 375줄)
- **적용사례 파일 총 7개**: 1001, 1007, 1008, 1012, 1019, 1021, 1024
...
- `output/docx_md/*.md` — DOCX→MD 변환 결과 (63개, 저작권/목차/시행일/의결문/적용사례 정제 완료)
- `output/docx_md/_TOC_*.md` — 목차 별도 저장 (3개)
- `output/docx_md/적용사례/*.md` — 적용사례 별도 분리 (7개: 1001, 1007, 1008, 1012, 1019, 1021, 1024)
