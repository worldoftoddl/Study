...
| --- |
| 자원 유출이 필요할 가능성이 높은 현재 의무가 존재한다. |
| 충당부채를 인식한다(문단 14). |
| 충당부채에 대한 공시를 해야 한다(문단 84와 85). |
...
| --- |
| 기업은 제삼자가 변제할 지출에 대해 어떠한 의무도 없다. |
| 변제될 금액에 대해 어떠한 부채도 없다(문단 57). |
| 공시할 의무는 없다. |
